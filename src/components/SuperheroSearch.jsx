    ...
    <section className='w-11/12 py-8 mx-auto my-2 text-blue-600 bg-gray-200 rounded-md shadow-sm md:mx-auto md:max-w-4xl bg-opacity-40'>
      ...
      <form className='max-w-lg px-4 mx-auto ' onSubmit={handleSubmit}>
        ...
        <div className='flex justify-center mt-0.5'>
          ...
          />
          <button
            className='p-2 px-4 ml-2 text-lg transition-colors duration-300 border-2 border-blue-600 rounded-xl focus:ring-blue-500 focus:ring-2 focus:outline-none focus:border-transparent hover:text-gray-100 hover:bg-blue-600 active:bg-blue-500'
            type='submit'
          >
            Search
          </button>
